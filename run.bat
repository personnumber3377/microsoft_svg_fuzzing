...
C:\Users\elsku\newtools\newwinafl\winafl\build64\bin\Release\afl-fuzz.exe -d -T 100000 -l C:\Users\elsku\final\python_mutator.dll  -i corpus -o findings -y -t 60000 -f input.svg -- -instrument_module MSOSVG.DLL -instrument_module gfx.dll -generate_unwind -stack_offset 1024 -iterations 100000000 -target_module sample.dll -target_offset 0x2030 -nargs 1 -persist -- "C:\Program Files\Microsoft Office\root\Office16\WINWORD.EXE"
